...
//   // value can be an object { label, value } OR a plain string
//   const resolvedValue = typeof value === "object" ? value.value : value;
//   const selected = options.find((opt) => opt.value === resolvedValue);

//   if (selected) {
//     setQuery(selected.label);
//   } else if (typeof value === "object" && value.label) {
//     // fallback: options not yet loaded but object already has a label
