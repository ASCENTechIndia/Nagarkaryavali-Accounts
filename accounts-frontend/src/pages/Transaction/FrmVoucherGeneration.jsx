  ...
  const fetchChequeBook = async ({
      ...
      try {
        ...
        if (books.length > 0) {
          ...
          Swal.fire({
            text:
              "This cheque is either used or does not exist",
