...
export const FrmAccIntDataRptValidationSchema = z.object({
  corporation: z.string().min(1, "नगरपालिका निवडा"),
  fromDate: z.date()
    .refine(date => date instanceof Date && !isNaN(date), "दिनांका पासून निवडा"),
  toDate: z.date()
    .refine(date => date instanceof Date && !isNaN(date), "दिनांका पर्यंत निवडा"),
...
export const FrmSdRefundRptValidationSchema = z.object({
  fromDate: z.date()
    .refine(date => date instanceof Date && !isNaN(date), "दिनांका पासून निवडा"),
  toDate: z.date()
    .refine(date => date instanceof Date && !isNaN(date), "दिनांका पर्यंत निवडा"),
...
export const FrmCashDepositValidationSchema = z.object({
  fromDate: z.date()
    .refine(date => date instanceof Date && !isNaN(date), "दिनांका पासून निवडा"),
  toDate: z.date()
    .refine(date => date instanceof Date && !isNaN(date), "दिनांका पर्यंत निवडा"),
...
export const FrmOnlineDepositValidationSchema = z.object({
  fromDate: z.date()
    .refine(date => date instanceof Date && !isNaN(date), "दिनांका पासून निवडा"),
  toDate: z.date()
    .refine(date => date instanceof Date && !isNaN(date), "दिनांका पर्यंत निवडा"),
...
export const FrmReceiptPaymentRegisterRptValidationSchema = z.object({
  fromDate: z.date()
    .refine(date => date instanceof Date && !isNaN(date), "दिनांका पासून निवडा"),
  toDate: z.date()
    .refine(date => date instanceof Date && !isNaN(date), "दिनांका पर्यंत निवडा"),
