...
//   if(filters.ulbId == 930) {
//     rawData = await repo.getJCMCDailyTransactionDetailedReport(filters);
//   }
//   else {
//     rawData = await repo.getDailyTransactionDetailedReport(filters);
//   }
...
//   if (filters.ulbId == 930) {
//     const processedTransNos = new Set();

//     rawData.forEach((row) => {
//       if (
//         row.RTransNo &&
//         !processedTransNos.has(row.RTransNo)
//       ) {
//         totalDiscountAmount += Number(
//           row.RDiscountAmount || 0
//         );

//         processedTransNos.add(row.RTransNo);
//       }
//     });
//   }
