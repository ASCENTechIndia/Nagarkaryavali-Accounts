...
//         const amount1 = getAmt("41215200001");
//         const amount2 = getAmt("41215200002");
//         const amount3 = getAmt("41215200003");
//         // const amount4 = getAmt("98938190004");
//         const amount5 = getAmt("41215200004");
//         const amount6 = getAmt("41215200005");
//         const amount7 = getAmt("41215200006") ;
//         const amount8 = getAmt("41215200007") ; 
...
//         const grandTotal = amount1 + amount2 + amount3 + amount5 + amount6 + amount7 + amount8 ;
...
const RptReceiptMKChallanPDFHelper = async ({ reportData, filters, corporationName, corporationLogo }) => {
    try {
        ...
        const amount7 = getAmt("45014100002");
        const amount8 = getAmt("04419900001"); 
        const amount9 = getAmt("91915890001");
        const amount10 = getAmt("44015800002");
        const amount11 = getAmt("45114200001");
        const amount12 = getAmt("92011200001");
