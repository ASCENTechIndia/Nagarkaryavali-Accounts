...
const RptReceiptSCPDFHelper = async ({ reportData, filters, corporationName, corporationLogo }) => {
  try {
    ...
    const amount4  = getAmt("91015890001")|| getAmt("91015890003"); 
    const amount5  = getAmt("91015200001") || getAmt("91015200002"); 
    ...
    const grandTotal = amount1 + total2to6 + total7to12 + amount13 + amount14;
