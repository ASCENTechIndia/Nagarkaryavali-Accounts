...
const generateDoubleEntryPDFHelper = async ({
  reportData = [],
  tableRows = [],
  filters = {},
  metaData = {}
  ...
  try {
    ...
    const templatePath = path.resolve(__dirname, "../../templates/double-entry-report-1.html");
    ...
    const fileName = `Double_Entry_Report_${timestamp}.pdf`;
