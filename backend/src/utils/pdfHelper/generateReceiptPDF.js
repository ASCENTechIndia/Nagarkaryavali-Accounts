...
const { PDFDocument } = require("pdf-lib"); // ✅ correct import
const QRCode = require("qrcode");
const numberToWords = require("number-to-words");

// ✅ for number word conversion
...
const generateReceiptPDF = async ({
  ...
  try {
    ...
    // ✅ __dirname is already available in CommonJS (NO import.meta.url needed)
    const templatePath = path.resolve(__dirname, "../../templates/receipt-detail.html");
    // const templatePath = path.resolve(__dirname, "../../templates/receipt-detail.html");
    ...
    const receiptData = {
      ...
      recno,
      ...receipt,
      collCenterUser, // 🔹 merge user data
      username,
      printDate,
      bharnaDate,
      amtinwords: amountInWords(receipt.totreceivedamt), // ✅ auto calculate
    };
